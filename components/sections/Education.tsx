      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        {education.map((e, i) => (
          <Reveal key={e.school} delay={i * 0.12}>
            <div className="h-full rounded-2xl border border-line bg-card p-6 backdrop-blur-sm transition-all duration-500 hover:border-acc2/40 hover:shadow-[0_0_36px_-14px_var(--glow)] sm:p-8">
